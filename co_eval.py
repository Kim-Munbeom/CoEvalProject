...
AGENT_CONFIGS = {
    "action_master": {
        ...
        "system_prompt": """멘토링 실행 지침 검수자. 멘티가 내일 즉시 실행 가능한지 평가.
평가 기준:
1. 수치/예시/도구명/구체적 단계 포함 여부
2. 추상적 표현 배제, 동사 중심 행동 지침 존재
3. Action Item 추출 및 리스트 작성""",
    },
    "pro_proof": {
        "description": "실무 디테일 검증가",
        "system_prompt": """10년차 실무 검증가. 검색 상식 vs 현업 지식 판별.
평가 기준:
1. 직무/업계 전문 용어 및 프로세스 정확성
2. 실제 경험/사례 기반 이유 설명 존재""",
    },
    "context_guardian": {
        "description": "현실성 분석가",
        "system_prompt": """멘티 현실성 분석가. 멘티 상황(연차/환경) 실현 가능성 평가.
평가 기준:
1. 멘티 수준/상황 충분 고려
2. 실행 리스크/조건 언급
3. 상황별 조언 최적성 및 맥락 설명""",
    },
    "quality_consensus": {
